...
parser.add_argument(
    "--t", "--threshold", help="Input mkf threshold", type=str, default=""
)
parser.add_argument(
    "--l", "--livetime", help="Input livetime file", type=str, default=""
)
...
def homegui():
    ...
    czti_pipeline_button = Button(
        czti_pipeline_frame,
        text="cztpipeline",
        font="Courier 20 bold",
        command=automaticgui,
        bg="#6272a4",
        fg="#f8f8f2",
        width=15,
    )
    ...
    cztflagbadpix_button = Button(
        czti_modules_frame,
        text="cztflagbadpix",
        font="Courier 20 bold",
        command=flagbadpixgui,
        bg="#6272a4",
        fg="#f8f8f2",
        width=15,
    )
    cztbindata_button = Button(
        czti_modules_frame,
        text="cztbindata",
        font="Courier 20 bold",
        command=bindatagui,
...
def man_bindata(
    bindata_quad_cleanevt,
    bindata_mkf,
    bindata_quad_badpix_outfits,
    bindata_quad_livetimefits,
):
    sp.call(
        [
            "cztbindata",
...
def gtigui():
    ...
    ilabel = Label(
        input_frame,
        text="Choose the required input files",
    ...
    b1 = Button(
        input_frame,
        text="Browse event file",
        command=open_evt_file,
        bg="#6272a4",
        fg="#f8f8f2",
    ...
    b2 = Button(
        input_frame,
        text="Browse mkf file",
        command=open_mkf_file,
        bg="#6272a4",
        fg="#f8f8f2",
        font="Courier 12 bold",
    )
    b3 = Button(
        input_frame,
        text="Browse mkf threshold file",
        command=open_mkf_thres_file,
        bg="#6272a4",
        fg="#f8f8f2",
        font="Courier 12 bold",
    )
    ...
    mkf_thres_label = Label(
        input_frame,
        text="Mkf Threshold file: ",
        bg="#282a36",
        fg="#f8f8f2",
        font="Courier 14",
    )
    ...
    olabel = Label(
        output_frame,
        text="Choose the required output directory",
        font="Courier 23 bold",
        bg="#282a36",
        fg="#f8f8f2",
    )
...
def gaasgui():
    ...
    evt_label = Label(
        input_frame, text="Event file: ", bg="#282a36", fg="#f8f8f2", font="Courier 14"
    )
    mkf_label = Label(
        input_frame, text="Mkf file: ", bg="#282a36", fg="#f8f8f2", font="Courier 14"
    )
    evt_label.pack(pady=10)
    mkf_label.pack(pady=10)
    ...
    directory_button = Button(
        output_frame, text="Open", command=output, bg="#6272a4", fg="#f8f8f2"
    )
    directory_button.pack(side=BOTTOM, pady=10)
    directory_label.pack(side=BOTTOM, padx=100, pady=45)
    olabel.pack(side=TOP, pady=10)
...
def dataselgui():
    ...
    b2 = Button(
        input_frame,
        text="Browse gti file",
        command=open_gti_file,
        bg="#6272a4",
        fg="#f8f8f2",
        font="Courier 12 bold",
    )
    ...
    gti_label = Label(
        input_frame, text="GTI file: ", bg="#282a36", fg="#f8f8f2", font="Courier 14"
    )
    evt_label.pack(pady=10)
...
def pixcleangui():
    ...
    b2 = Button(
        input_frame,
        text="Browse livetime file",
        command=open_livetime_file,
        bg="#6272a4",
        fg="#f8f8f2",
        font="Courier 12 bold",
    )
...
def flagbadpixgui():
    ...
    b2 = Button(
        input_frame,
        text="Browse badpix file",
        command=open_badpix_file,
        bg="#6272a4",
        fg="#f8f8f2",
        font="Courier 12 bold",
    )
    ...
    badpix_label = Label(
        input_frame, text="Badpix file: ", bg="#282a36", fg="#f8f8f2", font="Courier 14"
    )
    evt_label.pack(pady=10)
...
def imagegui():
    ...
    b1 = Button(
        input_frame,
        text="Browse DPI/DPH file",
        command=open_dpi_or_dph_file,
        bg="#6272a4",
        fg="#f8f8f2",
        font="Courier 12 bold",
    )
    dpiordph_label = Label(
        input_frame,
        text="DPI/DPH file: ",
        bg="#282a36",
        fg="#f8f8f2",
    ...
    b2 = Button(
        input_frame,
        text="Choose aspect files directory",
        command=aspect_dir,
        bg="#6272a4",
        fg="#f8f8f2",
        font="Courier 12 bold",
...
def open_evt_file():
    ...
    evt_label.config(
        text="Event file: " + os.path.basename(evt), font="Courier 12 bold"
    )
...
def open_mkf_thres_file():
    ...
    mkf_thres_label.config(
        text="Mkf Threshold file: " + os.path.basename(mkf_threshold),
        font="Courier 12 bold",
    )
...
def open_livetime_file():
    ...
    livetime_label.config(
        text="Livetime file: " + os.path.basename(livetime), font="Courier 12 bold"
    )
...
def open_badpix_file():
    ...
    badpix_label.config(
        text="Badpix file: " + os.path.basename(badpix), font="Courier 12 bold"
    )
...
def open_dpi_or_dph_file():
    ...
    dpiordph_label.config(
        text="DPI/DPH file: " + os.path.basename(imginp), font="Courier 12 bold"
    )
...
def lightcurves():
    ...
    for i in range(0, 4):
        ...
        plt.ylabel("Counts/s")
        plt.plot(
            clean_lc[i].field("TIME"),
            clean_lc[i].field("RATE"),
            color="mediumslateblue",
        )
        plt.savefig(
            evt.replace("bc.evt", "quad_clean_") + "Q" + str(i) + "_lightcurve.png"
        )
        plt.close()
...
def automaticgui():
    ...
    mkf_thres_label = Label(
        input_frame,
        text="Mkf Threshold file: " + mkf_threshold,
        bg="#282a36",
        fg="#f8f8f2",
        font="Courier 14",
    )
